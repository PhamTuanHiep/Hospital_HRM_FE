...
interface UpdateWorkEmployeeModalProps {
  isModalOpen: boolean;
...
const UpdateWorkEmployeeModal = ({
  isModalOpen,
  setIsModalOpen,
  setReset,
  employee,
  confirmLoading,
}: UpdateWorkEmployeeModalProps) => {
      ...
      >
        ...
        <Flex vertical style={{ width: "100%" }}>
          ...
          <Form.Item<UserPost> label={t("content.info.Status")} name="status">
            <Select className="input-profile-item" options={optionUserStatus} />
          </Form.Item>
        </Flex>
        {/* </Flex> */}
      </Form>
...
export default UpdateWorkEmployeeModal;
