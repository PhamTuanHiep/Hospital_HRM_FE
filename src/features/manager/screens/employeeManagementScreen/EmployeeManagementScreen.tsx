...
import ViewUserModel from "./viewUserModel/ViewUserModel";
import DeleteUserModal from "./viewUserModel/DeleteUserModal";
...
const EmployeeManagementScreen = () => {
  ...
  return (
    <div>
      <Button type="primary" className="btn-add-object ">
        Add User
      </Button>
      <Table<UsersData>
